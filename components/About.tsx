    ...
    >
      ...
      <div className="space-y-10 px-0 md:px-10">
        ...
        <p className="text-base">
          ...
          languages qui ont très peu de secret pour moi. Bien évidemment,
          l'univers du web étant en évolution perpétuelle, il me reste toujours
          de nouvelles chose à découvrir. Le travail en équipe ne m'est pas
          inconnu et je suis toujours à l'écoute des remarques de ceux avec qui
          je travaille. Ainsi les projets que j'ai réalisé au cours de ma
          formation chez OpenClassrooms reflète de ma tenacité quant à
          l'aboutissement d'une fonctionnalité que j'ai à implémenter, mais
          témoigne également d'un travail de qualité que je suis en mesure de
